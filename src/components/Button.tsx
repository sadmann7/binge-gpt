  ...
  (
    ...
    return (
      <button
        ...
        } flex h-10 w-full items-center justify-center rounded-md border border-transparent px-4 py-2 text-base font-medium shadow-sm focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:ring-offset-1 focus:ring-offset-indigo-100 disabled:cursor-not-allowed disabled:opacity-80 ${
          className ?? ""
        }`}
        ref={ref}
        {...props}
